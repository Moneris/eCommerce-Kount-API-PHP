...
class kountHttpsPost{
 ...
 function kountHttpsPost($storeid,$apitoken,$kountRequestOBJ)
 {
...
class kountResponse{
 ...
 function kountResponse($xmlString)
 {
...
function toXML()
{
 ...
 for($x=0;$x < $txnArrayLen;$x++)
 {
    ...
    {
	  if ( strlen($txn[$txnTypeArray[$i]]) > 0 )
	  {
